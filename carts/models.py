...
class CartItem(models.Model):
	...
	line_item_total=models.DecimalField(max_digits=10,decimal_places=2,default=499.99)
...
class Cart(models.Model):
	...
	tax_percentage=models.DecimalField(max_digits=40,decimal_places=5,default=0.085)
